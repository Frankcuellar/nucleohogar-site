...
.brand img.brand-logo{height:60px;width:auto;display:block}
...
.final-cta-logo{height:84px;width:auto;margin:0 auto 22px}
...
.footer-brand img.footer-logo{height:72px;width:auto;display:block}
...
@media (max-width:767px){
  ...
  .footer-brand img.footer-logo{height:62px}
}
`
...
<header class="nav">
  <div class="container nav-inner">
    <a href="/" class="brand" aria-label="${BRAND} — ${BRAND_TAGLINE}">
      <img src="/nucleo-hogar-horizontal.svg" alt="${BRAND} — ${BRAND_TAGLINE}" class="brand-logo" width="240" height="60">
    </a>
  ...
  <div class="container hero-grid">
    <div>
      ...
      <div class="trust-row">
        ...
        <div class="t"><b>5.0 ★</b><span>en Google · 3 opiniones</span></div>
        <div class="t"><b>WhatsApp</b><span>atención y seguimiento</span></div>
      </div>
    </div>
    ${heroVisualHtml}
  </div>
      ...
      <div class="solucion-visual">
        <div>
          ...
          <div class="stats">
            ...
            <div class="stat"><b>5.0 ★</b><span>3 opiniones en Google</span></div>
          </div>
        </div>
      </div>
...
<section class="final-cta">
  <div class="final-cta-inner">
    <img src="/nucleo-hogar-horizontal-white.svg" alt="${BRAND} — ${BRAND_TAGLINE}" class="final-cta-logo" width="320" height="100">
  ...
  <div class="container">
    <div class="footer-grid">
      <div class="footer-brand">
        <img src="/nucleo-hogar-horizontal-white.svg" alt="${BRAND} — ${BRAND_TAGLINE}" class="footer-logo" width="280" height="86">
...
document.addEventListener('DOMContentLoaded',function(){
  document.querySelectorAll('a[href*="wa.me"]').forEach(function(link){
    link.addEventListener('click',function(e){
      ...
      var servicio=el.getAttribute('data-servicio')||'${s.category || 'general'}';
      var ubicacion=el.getAttribute('data-ubicacion');
      if(!ubicacion){
        if(el.classList.contains('nav-cta-desktop'))ubicacion='header';
        else if(el.classList.contains('wa-float'))ubicacion='floating_button';
        else if(el.closest&&el.closest('.hero'))ubicacion='hero';
        else if(el.closest&&el.closest('.final-cta'))ubicacion='final_cta';
        else if(el.closest&&el.closest('.cases'))ubicacion='caso_'+servicio;
